...
//            发送通知给自己
            noticeService.sendNoticeToSelf("赞助商创建奖品信息申请",message,"赞助商",UAccount,"","N");
            return 0;
        }else {
...
//            发送通知给自己
            noticeService.sendNoticeToSelf("赞助商删除奖品信息申请",message,"赞助商",UAccount,"","N");
            return 0;
        }else {
    ...
    public List<Prize> selectAllPrize() {
        List<Prize> prizeList=prizeMapper.selectList(null);
        return prizeList;
    }
}
